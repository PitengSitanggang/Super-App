@extends('layouts.app')
@section('header_title', 'Buat RPP')
@section('content')
<div class="max-w-4xl mx-auto w-full">
    <div class="mb-6 flex items-center justify-between">
        <h1 class="text-3xl font-bold text-gray-800">Buat Rencana Pembelajaran</h1>
    ...
    <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-100">
        <form action="{{ route('lesson-plans.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <p class="text-xs text-gray-400 mt-1">Daftar ini hanya menampilkan mata pelajaran yang di-assign kepada Anda.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block text-gray-700 text-sm font-medium mb-2">Tanggal Mulai</label>
                    <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai') }}" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai') }}" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">
            ...
            <div class="space-y-6 mb-6">
                <div>
                    ...
                    <textarea name="kompetensi_dasar" rows="3" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('kompetensi_dasar') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="materi_pokok" rows="3" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('materi_pokok') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="tujuan_pembelajaran" rows="3" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('tujuan_pembelajaran') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="metode_pembelajaran" rows="2" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('metode_pembelajaran') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="sumber_belajar" rows="2" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('sumber_belajar') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="penilaian" rows="3" required class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('penilaian') }}</textarea>
